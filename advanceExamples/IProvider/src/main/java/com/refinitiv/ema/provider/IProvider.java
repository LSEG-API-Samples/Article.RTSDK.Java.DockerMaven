...
class AppClient implements OmmProviderClient
{
	...
	{
		String[] cowargs = new String[]{"-f", "cow", "IProvider: Receive Login Request message"};
	...
	void processMarketPriceRequest(ReqMsg reqMsg, OmmProviderEvent event)
	{
		...
		String[] cowargs = new String[]{"-f", "cow", "IProvider: Send  Market Price Refresh message"};
		String result = Cowsay.say(cowargs);
		System.out.println(result);
...
public class IProvider
{
	public static void main(String[] args)
	{
		...
		try
		{
			...
			cowargs = new String[]{"-f", "cow", "Starting IProvider application, waiting for a consumer application"};
			result = Cowsay.say(cowargs);
			System.out.println(result);
		...
		{
			if (provider != null) {
				cowargs = new String[]{"-f", "cow", "Uninitialize, Bye Bye"};
				result = Cowsay.say(cowargs);
				System.out.println(result);
